...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> _saveUserData(Map<String, dynamic> loginData) async {
    ...
    prefs.setString('userid', loginData['Id']?.toString().trim() ?? '');
    prefs.setString('name', loginData['EmpName']?.toString().trim() ?? '');
    prefs.setString('empCode', loginData['EmpCode']?.toString().trim() ?? '');
    prefs.setString('companyID', loginData['CompanyID']?.toString().trim() ?? '');
    prefs.setString('status', loginData['Status']?.toString().trim() ?? '');
    prefs.setString('usertype', 'Employee');
